...
import { IoCalendarClearOutline, IoTicketOutline, IoQrCodeSharp } from "react-icons/io5";
import { TiLocationOutline } from "react-icons/ti";
import { AiOutlineInstagram, AiOutlineTwitter } from "react-icons/ai";
import { BiLogoWhatsapp, BiLogoFacebookCircle } from "react-icons/bi";

function CourseManagment2() {
  return (
        ...
        <article className="relative border border-[#fbdfdf] w-full max-w-[320px] sm:max-w-[352px] h-auto lg:h-[447px] bg-[#f9f5f5]">
          ...
          <footer className="w-[90%] lg:w-[322px] mx-auto my-3 lg:my-[15px] mb-4 lg:mb-[20px] flex justify-between items-start">
            ...
            <div className="flex flex-col items-end gap-1 lg:gap-[2px]">
              <p className="text-lg lg:text-[20px] font-semibold leading-tight lg:leading-[26px]">₹4299</p>
              <p className="text-xs lg:text-[12px] font-medium text-[#189200]">Paid</p>
            </div>
          </footer>
          ...
          <div className="absolute w-[358px] top-[-4px] left-1/2 -translate-x-1/2 pointer-events-none">
            <div className="flex justify-between">
              <span
                ...
                style={{ borderColor: "transparent #fbdfdf #fbdfdf transparent" }}
              ></span>
              <span
                className="h-[30px] w-[30px] rounded-full border bg-[#FCFCFC]"
                style={{ borderColor: "transparent transparent #fbdfdf #fbdfdf" }}
              ></span>
            </div>
          </div>
            ...
            <div className="flex flex-row">
              {Array.from({ length: 12 }).map((_, i) => (
                <span
                  key={i}
                  className="h-[30px] w-[30px] rounded-full border bg-[#FCFCFC]"
                  style={{ borderColor: "#fbdfdf transparent transparent transparent" }}
                ></span>
              ))}
            </div>
          </div>
        ...
        <aside className="relative border border-[#fbdfdf] w-full max-w-[320px] sm:max-w-[500px] lg:max-w-[884px] h-auto lg:h-[447px] bg-[#f9f5f5]">
          <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center w-full max-w-[290px] sm:max-w-[460px] lg:max-w-[790px] mx-auto mt-8 lg:mt-[100px] px-4 lg:px-0 pb-8 lg:pb-0">
            <div className="text-center mb-6 lg:mb-0">
              <IoQrCodeSharp size={window.innerWidth < 640 ? 150 : window.innerWidth < 1024 ? 180 : 230} />
            ...
            <div className="w-full max-w-[280px] lg:max-w-[314px] flex flex-col items-center lg:mt-[50px] gap-2 lg:gap-[8px]">
              ...
              <div className="flex items-center justify-center h-[40px] lg:h-[48px] gap-2 lg:gap-[7px] mt-2 lg:mt-[8px]">
                <AiOutlineInstagram size={30} color="#D266A8" className="lg:w-[37px] lg:h-[37px]" />
                <BiLogoFacebookCircle size={30} color="blue" className="lg:w-[37px] lg:h-[37px]" />
                <BiLogoWhatsapp size={30} color="#61FD7D" className="lg:w-[37px] lg:h-[37px]" />
                <AiOutlineTwitter size={30} color="#1EA1F2" className="lg:w-[37px] lg:h-[37px]" />
              </div>
              <div className="w-full mt-6 lg:mt-[37px] py-3 lg:py-[15px] rounded-[5px]  text-center">
                <button className="text-white font-medium text-sm bg-[#ba2300] lg:text-base">Confirm & Update</button>
              </div>
            </div>
          </div>
          ...
          <div className="absolute w-[900px] bottom-[-9px] left-[-10px]">
            <div className="flex justify-between">
              <span
                ...
                style={{ borderColor: "#fbdfdf #fbdfdf transparent transparent" }}
              ></span>
              <span
                className="h-[40px] w-[40px] rounded-full border bg-[#FCFCFC]"
                style={{ borderColor: "#fbdfdf transparent transparent #fbdfdf" }}
              ></span>
            </div>
          </div>
            ...
            <div className="flex flex-row">
              {Array.from({ length: 13 }).map((_, i) => (
                <span
                  ...
                  style={{ borderColor: "transparent transparent #fbdfdf transparent" }}
                ></span>
              ))}
            </div>
          </div>
...
export default CourseManagment2;
