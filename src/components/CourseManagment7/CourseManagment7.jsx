...
// ✅ Single Card Component - Now Responsive
    ...
    <div className="border border-gray-300 rounded-[15px] shadow-md w-full max-w-[330px] min-w-[300px] h-auto min-h-[162px] flex pr-3 items-center gap-2">
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-1.5 py-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-[13px] sm:text-[15px] font-normal truncate">{date}</p>
        </div>
        ...
        <div className="flex items-start gap-2">
          <div className="flex items-center gap-1.5 flex-shrink-0">
            <FiGlobe size={13} />
            <p className="text-[11px] sm:text-[12px] text-black/70 whitespace-nowrap">Topic:</p>
          </div>
          <p className="text-[11px] sm:text-[12px] font-bold break-words">{topic}</p>
        </div>
        ...
        <div className="flex items-start gap-2">
          <div className="flex items-center gap-1.5 flex-shrink-0">
            <FiGlobe size={13} />
            <p className="text-[11px] sm:text-[12px] text-black/70 whitespace-nowrap">Language:</p>
          </div>
          <p className="text-[11px] sm:text-[12px] font-bold break-words">{language}</p>
        </div>
        ...
        <div className="border border-[#BB0E00] rounded-[5px] bg-gradient-to-b from-[#BB0E00] to-[#B94400] flex justify-center items-center h-[31px] mt-1">
          <button className="text-white text-[11px] sm:text-[12px] px-2 cursor-pointer">Assign & Notify</button>
        </div>
      </div>
    </div>
  );
...
function CourseManagment7() {
  const cardData = [
    { name: "Aditi R. Sharma", date: "Jul 18, 2025 | 8:00 PM", topic: "Marriage Consultation", language: "Hindi" },
    { name: "Aditi R. Sharma", date: "Jul 19, 2025 | 7:00 PM", topic: "Career Guidance", language: "English" },
    { name: "Aditi R. Sharma", date: "Jul 20, 2025 | 5:30 PM", topic: "Family Counseling", language: "Hindi" },
    { name: "Aditi R. Sharma", date: "Jul 18, 2025 | 8:00 PM", topic: "Marriage Consultation", language: "Hindi" },
    { name: "Aditi R. Sharma", date: "Jul 19, 2025 | 7:00 PM", topic: "Career Guidance", language: "English" },
    { name: "Aditi R. Sharma", date: "Jul 20, 2025 | 5:30 PM", topic: "Family Counseling", language: "Hindi" },
    { name: "Aditi R. Sharma", date: "Jul 18, 2025 | 8:00 PM", topic: "Marriage Consultation", language: "Hindi" },
  ...
  return (
    <Layout>
      ...
      {/* Footer */}
      <p className="text-black/60 text-[14px] sm:text-[15px] font-medium text-center mt-7 px-3">
...
export default CourseManagment7;
