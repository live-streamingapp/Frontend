        ...
        <div className="w-full">
          ...
          <div className="flex flex-col gap-4 sm:hidden">
            <div className="flex justify-between items-center">
              ...
              <p className="text-[14px] font-medium leading-[18px]">Swati Joshi</p>
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="text-[14px] font-medium leading-[18px]">Rahul Mehta</p>
            </div>
          ...
          <div className="hidden sm:flex justify-between items-start w-full">
            ...
            <div className="flex flex-col items-end gap-[25px]">
              <div>
                <p className="text-[16px] lg:text-[18px] font-medium leading-[20px] lg:leading-[23px]">Swati Joshi</p>
              </div>
              <div>
                <p className="text-[16px] lg:text-[18px] font-medium leading-[20px] lg:leading-[23px]">Rahul Mehta</p>
              </div>
              <div>
                <p className="text-[16px] lg:text-[18px] font-medium leading-[20px] lg:leading-[23px]">₹899</p>
              </div>
              <div>
                <p className="text-[16px] lg:text-[18px] font-medium leading-[20px] lg:leading-[23px]">Jul 14</p>
              </div>
              <div>
                <p className="text-[16px] lg:text-[18px] font-medium leading-[20px] lg:leading-[23px]">5:00 PM</p>
              </div>
              <div>
...
export default CourseManagment8;
