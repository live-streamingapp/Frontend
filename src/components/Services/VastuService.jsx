        ...
        {packages.map((pkg, index) => (
          ...
          >
            ...
            <div className="flex gap-[1rem] justify-between items-center">
              ...
              <button className="flex-1/2 px-4 py-[12px] bg-gradient-to-b from-[#BB0E00] to-[#B94400] shadow-inner rounded-[5px] border border-[#BB0E00] text-white text-[14px] font-semibold leading-[18.2px]">
                Buy Package
              </button>
            </div>
          </div>
