...
import Guruji from "../../../public/images/Guruji.png";
import AstroChat from "../../../public/images/AstroChat.png";
      ...
      <div className="mx-1 xs:mx-2 sm:mx-4 md:mx-6 mt-8 bg-white">
        ...
        <div className="bg-white flex flex-col lg:flex-row gap-4 lg:gap-2.5 justify-between border border-[#E1E1E1] rounded-[15px] w-full max-w-4xl mx-auto p-3 xs:p-4 sm:p-5 shadow-[0_4px_14.6px_0_rgba(0,0,0,0.10)]">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            <h3 className="text-[1.1rem] sm:text-[1.2rem] font-semibold mb-3">About The Event</h3>
            ...
            <div className="mb-4">
              <h4 className="font-semibold mb-2 text-sm sm:text-base">Top Mentors</h4>
