...
const StudentCard = ({ student }) => {
  ...
  return (
    <div className="bg-white shadow-md rounded-xl w-[344px] overflow-hidden">
      {/* Top gradient header */}
      <div className="bg-gradient-to-b from-[#BB0E00] to-[#B94400] w-[344px] h-[160px] flex flex-col items-center justify-start pt-3 relative">
      ...
      <div className="flex gap-2 justify-center mt-4 mb-4">
        <button className="bg-[#BB0E00] text-white px-4 py-1 rounded-md hover:opacity-90">
          View
        </button>
      </div>
    </div>
